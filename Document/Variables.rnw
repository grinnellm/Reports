...
The COVID-19 pandemic has affected British Columbia (BC) in many ways this year, including our ability to collect and analyse Pacific Herring data.
Because the pandemic and associated provincial response changed rapidly during the Pacific Herring field program season, stock assessment regions (SARs) with later spawns were affected more than SARs with earlier spawns.
...
Although Pacific Herring biosamples were collected as usual, the analysis of biosample data has been delayed for all SARs.
...
This lab has been inoperative since March \nth{16}, when most PBS staff were required to work from home.
Thus, the COVID-19 pandemic delayed the analysis of age data for Pacific Herring and many other species.
To address this backlog efficiently, senior science staff and fisheries managers at DFO are prioritizing species to analyse when the sclerochronology lab restarts.
Unfortunately, it may not be possible to analyse all the Pacific Herring age data in time for stock assessments this year.\par
The COVID-19 pandemic has also affected our ability to assess Pacific Hering stocks.
...
Again, senior science staff and fisheries managers are prioritizing Pacific Herring SARs for stock assessments.
