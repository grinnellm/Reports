...
The COVID-19 pandemic affected the collection and analysis of Pacific Herring data throughout British Columbia (BC) this year.
In addition, fewer DFO staff were able to be in the field this year.
Because the pandemic started impacting BC during the field program season, SARs with later spawns were affected more than SARs with earlier spawns.
For example, spawn was surveyed by surface surveys instead of underwater dive surveys in Prince Rupert District and Haida Gwaii.\par
...
The COVID-19 pandemic has also affected our ability assess Pacific Hering stocks.
