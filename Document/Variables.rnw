...
\newcommand{\spawnIndexTechReport}{See the \href{https://github.com/grinnellm/SpawnIndex/blob/master/tr/Draft.pdf}{draft spawn index techincal report} for calculations to convert SOK harvest to spawning biomass.}
...
This delay is most notable for age data which are analysed at the sclerochronology lab at the Pacific Biological Station (PBS).
This lab has been inoperative since March \nth{16} when most PBS staff were required to work from home.
Thus, the COVID-19 pandemic delayed the analysis of age data for Pacific Herring and other species.
...
The COVID-19 pandemic may also affect our ability to assess Pacific Herring stocks.
Although we hope to assess Pacific Herring stocks as usual, we may be unable to develop formal stock assessments for each major SAR this year.
Again, senior science staff and fisheries managers are prioritizing Pacific Herring SARs for stock assessments.
We expect that high priority SARs will also have priority for age data analysis.
