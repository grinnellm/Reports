...
The coronavirus pandemic impacted our ability to collect and analyse Pacific Herring data throughout British Columbia in 2020.
...
Because there is a delay in the analysis of biosample data, this version of the report has some missing tables and figures, and/or missing 2020 data in tables and figures.
