...
% COVID-19 comment
\newcommand{\covid}{\section{COVID-19}
The COVID-19 pandemic affected British Columbia (BC) in many ways, including our ability to collect and analyse Pacific Herring data this year.
In addition, the pandemic affected fishing opportunities, and reduced our ability to be in the field.
Because the pandemic and the associated response in BC changed rapidly during the Pacific Herring field program season, SARs with later spawns were affected more than SARs with earlier spawns.
...
Although Pacific Herring biosamples were collected as usual, the analysis of biosample data has been delayed in all SARs.
This is particularly true for age data, which are analysed at the sclerochronology lab at the Pacific Biological Station (PBS).
This lab has not been operational since March \nth{16}, when most PBS staff were required to work from home.
Thus, the COVID-19 pandemic delayed the analysis of age data for Pacific Herring and many other species.
To address this backlog in an efficient manner, fisheries managers and senior science staff at DFO are working on a priority list for species data to analyse in the sclerochronology lab.
Unfortunately, it may not be possible to have all the Pacific Herring age data analysed in time for stock assessments.\par
The COVID-19 pandemic also affects our ability assess Pacific Hering stocks.
Although we hope to assess Pacific Hering stocks as usual, we may not be able to develop formal stock assessments for each major SAR this year.
Again, Fisheries managers and senior science staff are working on a priority list for the assessment of Pacific Herring SARs.
We appreciate your patience and understanding as we continue to work from home in these uncertain and fast-changing times.}
