...
\newcommand{\qPeriods}{The spawn index has two distinct periods defined by the dominant coastwide survey method: surface surveys (\Sexpr{qYrs$q1}), and dive surveys (\Sexpr{qYrs$q2}).}
...
Spawn surveys proceeded as usual in most areas in 2021, with dive surveys in all major areas except Haida Gwaii.
